...
Revision ID: 09c443d5fc77
Revises: 
Create Date: 2025-02-14 16:32:35.914913
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('QUEUED', 'RUNNING', 'COMPLETED', 'FAILED', 'STOPPED', name='trainingstatus'), nullable=False),
    ...
    sa.Column('training_logs', sa.JSON(), nullable=True),
    sa.Column('metrics', sa.JSON(), nullable=True),
